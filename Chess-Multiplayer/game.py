...
def menu_screen(win, name):
    ...
    while run:
        ...
        txt1 = small_font.render("Click to Continue", True, (255, 0, 0))
        txt2 = small_font.render("& Enter the Code in Terminal", True, (255, 0, 0))
        win.blit(txt1, (10,10))
        win.blit(txt2, (10,100))
...
def redraw_gameWindow(win, bo, p1, p2, color, ready):
    ...
    try:
        txt = font.render("Player 1: "+bo.p1Name, 1, (255, 255, 255))
        txt2 = font.render("Player 2: "+bo.p2Name, 1, (255,255,255))
